...
el("diagnosticVersion").textContent=`${manifest.version} · FINAL-PROD-3.1.1-PAGE-CDP`;
...
addLog("success","Build corretta caricata",`versione ${manifest.version} · FINAL-PROD-3.1.1-PAGE-CDP`);
