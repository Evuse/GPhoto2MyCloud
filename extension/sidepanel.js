"use strict";
const ids = ["destination", "extractedFolder", "downloadRoot", "batchSize", "clickDelayMs", "settleSeconds", "rangeSelection", "verifyCopies", "keepArchives"];
...
el("diagnosticVersion").textContent=`${manifest.version} · FINAL-PROD-3.2-LOCAL-ZIP`;
...
addLog("success","Build corretta caricata",`versione ${manifest.version} · FINAL-PROD-3.2-LOCAL-ZIP`);
